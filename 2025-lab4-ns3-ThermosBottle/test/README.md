...
举例而言，`test-utils/run_test.sh /home/student/workspace/ns-allinone-3.38/ns-3.38 cwnd` 可用于单独测试 Exercise 4 (cwnd)，`test-utils/run_test.sh /home/student/workspace/ns-allinone-3.38/ns-3.38 all` 可用于测试所有需要测试的三个 Exercise (pcap, cwnd, fct) 。
